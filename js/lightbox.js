(function() {
    ...
    var metLightbox = {
        ...
        lightbox: function(imagen) {
            // Slice sirve para borrar caracteres de un string
            propLightbox.imagenSrc = getComputedStyle(imagen, null).backgroundImage.slice(5, -2);
            ...
            propLightbox.lightbox_container.style.zIndex = '1050';
            ...
            propLightbox.modal.innerHTML += '<i id="cerrar-modal" class="fas fa-times"></i>'
